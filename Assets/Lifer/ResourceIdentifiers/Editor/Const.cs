...
namespace Lifer.ResourceIdentifiers {
    ...
    public static class Const {
        ...
        public static readonly HashSet<string> ReserveIdentifiers =
            new HashSet<string>() {
                "abstract",
                "add",
                "alias",
